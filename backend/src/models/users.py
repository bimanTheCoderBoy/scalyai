...
class User(BaseModelMixin,Base):
    ...
    sent_invites = relationship("BusinessInvite", back_populates="from_user",foreign_keys=[BusinessInvite.from_user_id], cascade="all, delete-orphan")
    received_invites = relationship("BusinessInvite", back_populates="to_user",foreign_keys=[BusinessInvite.to_user_id], cascade="all, delete-orphan")