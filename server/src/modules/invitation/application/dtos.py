...
from modules.invitation.domain.entity import BusinessInviteStatus


class BusinessInviteRequestSchema(BaseModel):
    business_id: int = Field(
        ..., description="The ID of the business to invite the user to"
    )
    to_user_id: int = Field(
        ..., description="The ID of the user receiving the invitation"
    )
    role: BusinessUserRole = Field(
        ..., description="The role of the user receiving the invitation"
    )
...
class BusinessInviteResponseSchema(BusinessInviteCreateSchema):
    ...
    status: BusinessInviteStatus = Field(
